...
**Project**: audio-gemini-chat 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I would like an audio chat interface with Gemini 1.5 Pro where audio is directly sent to the model as input and use Piper TTS in browser to perform TTS. There should be visual indicators of what happening every step of the way, we want to quickly get the audio to the model so use a compress mp3 format if it's fast than wav. 
...
```sh
git clone https://github.com/GPT-Engineer-App/audio-gemini-chat.git
cd audio-gemini-chat
npm i
